...
1, 添加线索备注
用户在线索明细页面,输入备注内容,点击"保存"按钮,完成添加线索备注的功能.
* 备注内容不能为空
* 添加成功之后,清空输入框,刷新备注列表
* 添加失败,提示信息,输入框不清空,列表也不刷新

2, 删除线索备注
用户在线索明细页面,点击"删除"线索备注的图标,完成删除线索备注的功能.
* 删除成功之后,刷新备注列表
* 删除失败,提示信息,备注列表不刷新

3, 修改线索备注
用户在线索明细页面,点击"修改"线索备注的图标,弹出修改线索备注的模态窗口;
用户在修改线索备注的模态窗口,填写表单,点击"更新"按钮,完成修改线索备注的功能.
* 备注内容不能为空
* 修改成功之后,关闭模态窗口,刷新备注列表
* 修改失败,提示信息,模态窗口不关闭,列表也不刷新
...
用户在线索转换页面,如果需要创建交易,则填写交易表单数据,点击"转换"按钮,完成线索转换的功能.
...
1, 创建客户
创建客户.
用户在客户主页面,点击"创建"按钮,弹出创建客户的模态窗口;
用户在创建客户的模态窗口填写表单,点击"保存"按钮,完成创建客户的功能.
* 所有者是动态的(//在现实客户主页面时，就从数据库中查询出所有用户并且显示在创建的模态窗口中)
* 所有者和名称不能为空
...
用户在客户主页面填写查询条件,点击"查询"按钮,显示所有符合条件的数据的第一页，保持每页显示条数不变
实现翻页功能.
* 在客户主页面,显示客户列表和记录的总条数
* 默认每页显示条数:10

3, 删除客户
用户在客户主页面,选择要删除的客户,点击"删除"按钮,弹出确认窗口;
用户点击"确定"按钮,完成删除客户的功能.
* 每次至少删除一条客户
* 可以批量删除客户
...
4, 修改客户
用户在客户主页面,选择要修改的客户,点击"修改"按钮,弹出修改客户的模态窗口;
用户在修改客户的模态窗口填写表单,点击"更新"按钮,完成修改客户的功能.
* 每次能且只能修改一条客户
* 所有者 动态的
* 表单验证(同创建)
...
5, 跳转至客户明细页面, 明细页面中关于备注, 交易, 联系人的功能未做

==========================================2020/12/13

1, 添加客户备注
用户在客户明细页面,输入备注内容,点击"保存"按钮,完成添加客户备注的功能.
* 备注内容不能为空
* 添加成功之后,清空输入框,刷新备注列表
* 添加失败,提示信息,输入框不清空,列表也不刷新

2, 删除客户备注
用户在客户明细页面,点击"删除"客户备注的图标,完成删除客户备注的功能.
* 删除成功之后,刷新备注列表
* 删除失败,提示信息,备注列表不刷新

3, 修改客户备注
用户在客户明细页面,点击"修改"客户备注的图标,弹出修改客户备注的模态窗口;
用户在修改客户备注的模态窗口,填写表单,点击"更新"按钮,完成修改客户备注的功能.
* 备注内容不能为空
* 修改成功之后,关闭模态窗口,刷新备注列表
* 修改失败,提示信息,模态窗口不关闭,列表也不刷新
...
4, 分页查询交易
当交易主页面加载完成之后,显示所有数据的第一页;
用户在交易主页面填写查询条件,点击"查询"按钮,显示所有符合条件的数据的第一页，保持每页显示条数不变
实现翻页功能.
* 在交易主页面,显示交易列表和记录的总条数
* 默认每页显示条数:10

5, 客户明细页面中删除交易和联系人的操作完成, 在客户明细页面中创建交易和联系人的操作未做

==========================================2020/12/14

未完成: 
1, 交易: 修改交易, 删除交易, 交易的明细页面
2, 联系人整个功能未做
