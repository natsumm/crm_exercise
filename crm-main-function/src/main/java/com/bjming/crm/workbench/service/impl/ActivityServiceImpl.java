...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Override
    public List<Activity> queryActivityForDetailByNameAndClueId(String name, String clueId) {
        return activityMapper.selectActivityForDetailByNameAndClueId(name, clueId);
    }
    ...
    public List<Activity> queryActivityForConvertByNameAndClueId(String name, String clueId) {
        return activityMapper.selectActivityForConvertByNameAndClueId(name, clueId);
    }
}
